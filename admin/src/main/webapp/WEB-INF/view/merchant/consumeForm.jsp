            ...
            <div class="am-u-sm-12">
                <form class="am-form" action="${ctx}/consume/save" method="post">
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4">
                                <input type="text" name="channel.name" class="am-input-sm"
                                       value="${consume.channel.name}" readonly/>
                            </div>
                            <div class="am-hide-sm-only am-u-md-6"></div>
                        </div>
                    </shiro:hasPermission>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="time" class="am-input-sm" value="${consume.time}" readonly/>
                        </div>
                    ...
                    <div class="am-g am-margin-top">
                        <div class="am-u-sm-4 am-u-md-2 am-text-right">支付金额：</div>
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="requestAmount" class="am-input-sm" value="${consume.requestAmount}"
                                   readonly/>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="merchantOrderNo" class="am-input-sm"
                                   value="${consume.merchantOrderNo}" readonly/>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    <div class="am-g am-margin-top">
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="payCost" class="am-input-sm" value="${consume.payCost}" readonly/>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="serviceCharge" class="am-input-sm" value="${consume.serviceCharge}"
                                   readonly/>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <input type="text" name="accountAmount" class="am-input-sm" value="${consume.accountAmount}"
                                   readonly/>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <textarea cols="20" rows="4" name="request" readonly>${consume.request} </textarea>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4">
                            <textarea cols="20" rows="4" name="response" readonly>${consume.response}</textarea>
                        </div>
                        <div class="am-hide-sm-only am-u-md-6"></div>
                    </div>
                    <div class="am-g am-margin-top">
