...
public class BatchWithdrawData {
    ...
    public JSONObject bulidBatchContentJosn(int detailNum, Xiafa xiafa) {
        ...
        //批付金额
        contentObject.put("totalAmount", (int) (xiafa.getAmount().doubleValue() * 100));//c33367701511b4f6020ec61ded352059
        ...
        contentObject.put("productCode", idWorker.nextId());

        contentObject.put("detailData", bulidDetailContentJosn(detailNum, batchNo, xiafa));
     ...
     * @since [产品/模块版本] （可选）
     */
    public JSONArray bulidDetailContentJosn(int detailNum, String batchNo, Xiafa xiafa) {
        ...
        for (int i = 0; i < detailNum; i++) {
            ...
            detailObject.put("orderName", idWorker.nextId());
